...
import { ApiHelperService } from '@admin-core/services/network/api-helper.service'; // Add this import
import { AuthService } from '@admin-core/services/auth.service'; // Add this import
import { SnackbarService } from '@valura-lib/service/snackbar/snackbar.service'; // Add this import
import { LoadingButtonComponent } from '@valura-lib/components//loading-button/loading-button.component';
import { IdpConfig } from '../login/login.component';
import { SSO_EXTERNAL_AUTH } from '@admin-core/constants/constants';
...
export class ExternalLoginComponent implements OnInit {
  ...
  verifyUser() {
    ...
    this.apiHelperService.verifyExternalUserSession({ email: this.email.value }).subscribe({
      next: (res: any) => {
        if (res && res.success) {
  ...
  verifyOtp() {
    ...
    this.apiHelperService.validateExternalUserOtp(body).subscribe({
      next: (res: any) => {
        if (res && res.success) {
          this.authService.externalLogin(res);
